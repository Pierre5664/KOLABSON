...
if (isset($_SESSION['pseudo']) && isset($_POST['commentaire']) && isset($_GET['id']) )//Si les champs pseudo, commentaire et id existent
{
    ...
    $req = $bdd->prepare('INSERT INTO commentairessample (id, pseudo, commentaire, fileID, dateCommentaireSample) VALUES(NULL, :pseudo, :commentaire, :fileID, :dateCommentaireSample)');
    $req->execute(array(
